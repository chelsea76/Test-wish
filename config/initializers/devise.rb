...
supported_omniauth_providers = {
  twitter: ['lX65QSAfvfpXqDKdIUWLUMuzK', 'ufoP24zgE9zEmtK70aaskIHsCbrox9MB18tFjeKWhRnQFHUUjx'],
...
Devise.setup do |config|
  ...
  # up on your models and hooks.
   config.omniauth :twitter, 'lX65QSAfvfpXqDKdIUWLUMuzK', 'ufoP24zgE9zEmtK70aaskIHsCbrox9MB18tFjeKWhRnQFHUUjx', scope: 'user,public_repo'
